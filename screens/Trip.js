  ...
  renderChart() {
    return (
      <Card shadow style={{ paddingVertical: theme.sizes.base * 2 }}>
        ...
        <Image source={require('../assets/images/Icon/ticket.png')} style={{width: 250, height: 100}} />
        ...
        <Fumi
            label={'Please Enter Flight Number'}
  ...
  renderMap() {
    return (
      <Card style={{ padding: 0, overflow: 'hidden'}}>
        <MapView
          region={{ latitude: 37.260150, longitude: 10.640325 , latitudeDelta: 1.5, longitudeDelta: 1.5}}
        ...
        >
          <Marker
            rotation={-15}
            anchor={{ x: 0.5, y: 0.5 }}
            coordinate={{ latitude: 37.260150, longitude: 10.640325 }}
          >
            <Badge color={rgba(theme.colors.primary, '0.2')} size={77}>
              <TouchableOpacity activeOpacity={0.8}>
                <Badge color={rgba(theme.colors.primary, '0.2')} size={57}>
                  <Icon.MaterialCommunityIcons name="airplane" size={57 / 2.5} color="black" />
                </Badge>
              </TouchableOpacity>
            </Badge>
          </Marker>
        ...
        <Badge color={rgba(theme.colors.accent, '0.1')} size={144}>
          <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.navigate("Welcome")}>
            <Badge color={theme.colors.accent} size={62}>
              <Icon.FontAwesome name="home" size={62 / 2.5} color="white" />
            </Badge>
          </TouchableOpacity>
        </Badge>
      </Block>
